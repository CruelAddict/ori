...
import { formatFilePath, type FormattedFilePath } from "./path-format";
...
describe("formatFilePath", () => {
  describe("basic paths", () => {
    test("file in home dir", () => runTest(
      "/Users/test/file.txt",
      { dirPath: "~/", fileName: "file.txt" },
    ));

    test("nested under home dir", () => runTest(
      "/Users/test/Documents/file.txt",
      { dirPath: "~/Documents/", fileName: "file.txt" }),
    );

    test("truncated under home dir", () => runTest(
    ...
    test("non-home path", () => runTest(
      "/var/log/app/error.log",
      { dirPath: "/var/log/app/", fileName: "error.log" },
    ));

    test("truncated non-home path", () => runTest(
    ...
    test("truncated filename", () =>
      runTest(
        "/Users/test/a/b/c/d/e/f/g/filllllllllllllle.txt",
        { dirPath: "…/", fileName: "filllllll…llle.txt" },
        20,
      ));
  });

  test("deep path", () => runTest(
    "/Users/test/a/b/c/d/e/f/g/file.txt",
    { dirPath: "~/a/b/c/…/g/", fileName: "file.txt" },
    20,
  ));
